...
<!--SCHEMA METADATA-->
<xsl:template match="/">
<svrl:schematron-output xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="Schematron validation for an OVAL Directives file" schemaVersion="">
<xsl:comment>
...
<svrl:ns-prefix-in-attribute-values uri="http://oval.mitre.org/XMLSchema/oval-directives-5" prefix="oval-dir"/>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Schematron validation for an OVAL Directives file</svrl:text>

<!--PATTERN oval_none_exist_value_dep-->


	<!--RULE -->
<xsl:template match="oval-def:oval_definitions/oval-def:tests/child::*" priority="1000" mode="M11">
...
<!--PATTERN oval-res_directives_include_oval_definitions-->
	...
	<!--RULE -->
<xsl:template match="oval-res:oval_results/oval-res:directives[@include_source_definitions='true' or @include_source_definitions='1' or not(@include_source_definitions)]" priority="1001" mode="M12">
...
<xsl:apply-templates select="@*|*" mode="M12"/>
	...
	<!--RULE -->
<xsl:template match="oval-res:oval_results/oval-res:directives[@include_source_definitions='false' or @include_source_definitions='0']" priority="1000" mode="M12">
...
<!--PATTERN oval-res_system-->
	...
	<!--RULE -->
<xsl:template match="oval-res:system[oval-res:tests]" priority="1001" mode="M13">
...
<xsl:apply-templates select="@*|*" mode="M13"/>
	...
	<!--RULE -->
<xsl:template match="oval-res:system[not(oval-res:tests)]" priority="1000" mode="M13">
...
<!--PATTERN oval-res_mask_rule-->
	...
	<!--RULE -->
<xsl:template match="/oval-res:oval_results/oval-res:results/oval-res:system/oval-sc:oval_system_characteristics/oval-sc:system_data/*/*|/oval-res:oval_results/oval-res:results/oval-res:system/oval-sc:oval_system_characteristics/oval-sc:system_data/*/*/*" priority="1000" mode="M14">
...
<!--PATTERN oval-res_directives-->
	...
	<!--RULE -->
<xsl:template match="oval-res:definition[@result='true' and oval-res:criteria]" priority="1011" mode="M15">
...
<xsl:apply-templates select="@*|*" mode="M15"/>
	...
	<!--RULE -->
<xsl:template match="oval-res:definition[@result='true' and not(oval-res:criteria)]" priority="1010" mode="M15">
...
<xsl:apply-templates select="@*|*" mode="M15"/>
	...
	<!--RULE -->
<xsl:template match="oval-res:definition[@result='false' and oval-res:criteria]" priority="1009" mode="M15">
...
<xsl:apply-templates select="@*|*" mode="M15"/>
	...
	<!--RULE -->
<xsl:template match="oval-res:definition[@result='false' and not(oval-res:criteria)]" priority="1008" mode="M15">
...
<xsl:apply-templates select="@*|*" mode="M15"/>
	...
	<!--RULE -->
<xsl:template match="oval-res:definition[@result='unknown' and oval-res:criteria]" priority="1007" mode="M15">
...
<xsl:apply-templates select="@*|*" mode="M15"/>
	...
	<!--RULE -->
<xsl:template match="oval-res:definition[@result='unknown' and not(oval-res:criteria)]" priority="1006" mode="M15">
...
<xsl:apply-templates select="@*|*" mode="M15"/>
	...
	<!--RULE -->
<xsl:template match="oval-res:definition[@result='error' and oval-res:criteria]" priority="1005" mode="M15">
...
<xsl:apply-templates select="@*|*" mode="M15"/>
	...
	<!--RULE -->
<xsl:template match="oval-res:definition[@result='error' and not(oval-res:criteria)]" priority="1004" mode="M15">
...
<xsl:apply-templates select="@*|*" mode="M15"/>
	...
	<!--RULE -->
<xsl:template match="oval-res:definition[@result='not evaluated' and oval-res:criteria]" priority="1003" mode="M15">
...
<xsl:apply-templates select="@*|*" mode="M15"/>
	...
	<!--RULE -->
<xsl:template match="oval-res:definition[@result='not evaluated' and not(oval-res:criteria)]" priority="1002" mode="M15">
...
<xsl:apply-templates select="@*|*" mode="M15"/>
	...
	<!--RULE -->
<xsl:template match="oval-res:definition[@result='not applicable' and oval-res:criteria]" priority="1001" mode="M15">
...
<xsl:apply-templates select="@*|*" mode="M15"/>
	...
	<!--RULE -->
<xsl:template match="oval-res:definition[@result='not applicable' and not(oval-res:criteria)]" priority="1000" mode="M15">
...
<!--PATTERN oval-res_testids-->
	...
	<!--RULE -->
<xsl:template match="oval-res:test" priority="1000" mode="M16">
...
<!--PATTERN oval-def_empty_def_doc-->
	...
	<!--RULE -->
<xsl:template match="oval-def:oval_definitions" priority="1000" mode="M17">
...
<!--PATTERN oval-def_required_criteria-->
	...
	<!--RULE -->
<xsl:template match="oval-def:oval_definitions/oval-def:definitions/oval-def:definition[(@deprecated='false' or @deprecated='0') or not(@deprecated)]" priority="1000" mode="M18">
...
<!--PATTERN oval-def_test_type-->
	...
	<!--RULE -->
<xsl:template match="oval-def:oval_definitions/oval-def:tests/*[@check_existence='none_exist']" priority="1000" mode="M19">
...
<!--PATTERN oval-def_setobjref-->
	...
	<!--RULE -->
<xsl:template match="oval-def:oval_definitions/oval-def:objects/*/oval-def:set/oval-def:object_reference" priority="1002" mode="M20">
...
<xsl:apply-templates select="@*|*" mode="M20"/>
	...
	<!--RULE -->
<xsl:template match="oval-def:oval_definitions/oval-def:objects/*/oval-def:set/oval-def:set/oval-def:object_reference" priority="1001" mode="M20">
...
<xsl:apply-templates select="@*|*" mode="M20"/>
	...
	<!--RULE -->
<xsl:template match="oval-def:oval_definitions/oval-def:objects/*/oval-def:set/oval-def:set/oval-def:set/oval-def:object_reference" priority="1000" mode="M20">
...
<!--PATTERN oval-def_literal_component-->
	...
	<!--RULE -->
<xsl:template match="oval-def:literal_component" priority="1000" mode="M21">
...
<!--PATTERN oval-def_arithmeticfunctionrules-->
	...
	<!--RULE -->
<xsl:template match="oval-def:arithmetic/oval-def:literal_component" priority="1001" mode="M22">
...
<xsl:apply-templates select="@*|*" mode="M22"/>
	...
	<!--RULE -->
<xsl:template match="oval-def:arithmetic/oval-def:variable_component" priority="1000" mode="M22">
...
<!--PATTERN oval-def_beginfunctionrules-->
	...
	<!--RULE -->
<xsl:template match="oval-def:begin/oval-def:literal_component" priority="1001" mode="M23">
...
<xsl:apply-templates select="@*|*" mode="M23"/>
	...
	<!--RULE -->
<xsl:template match="oval-def:begin/oval-def:variable_component" priority="1000" mode="M23">
...
<!--PATTERN oval-def_concatfunctionrules-->
	...
	<!--RULE -->
<xsl:template match="oval-def:concat/oval-def:literal_component" priority="1001" mode="M24">
...
<xsl:apply-templates select="@*|*" mode="M24"/>
	...
	<!--RULE -->
<xsl:template match="oval-def:concat/oval-def:variable_component" priority="1000" mode="M24">
...
<!--PATTERN oval-def_endfunctionrules-->
	...
	<!--RULE -->
<xsl:template match="oval-def:end/oval-def:literal_component" priority="1001" mode="M25">
...
<xsl:apply-templates select="@*|*" mode="M25"/>
	...
	<!--RULE -->
<xsl:template match="oval-def:end/oval-def:variable_component" priority="1000" mode="M25">
...
<!--PATTERN oval-def_escaperegexfunctionrules-->
	...
	<!--RULE -->
<xsl:template match="oval-def:escape_regex/oval-def:literal_component" priority="1001" mode="M26">
...
<xsl:apply-templates select="@*|*" mode="M26"/>
	...
	<!--RULE -->
<xsl:template match="oval-def:escape_regex/oval-def:variable_component" priority="1000" mode="M26">
...
<!--PATTERN oval-def_splitfunctionrules-->
	...
	<!--RULE -->
<xsl:template match="oval-def:split/oval-def:literal_component" priority="1001" mode="M27">
...
<xsl:apply-templates select="@*|*" mode="M27"/>
	...
	<!--RULE -->
<xsl:template match="oval-def:split/oval-def:variable_component" priority="1000" mode="M27">
...
<!--PATTERN oval-def_substringfunctionrules-->
	...
	<!--RULE -->
<xsl:template match="oval-def:substring/oval-def:literal_component" priority="1001" mode="M28">
...
<xsl:apply-templates select="@*|*" mode="M28"/>
	...
	<!--RULE -->
<xsl:template match="oval-def:substring/oval-def:variable_component" priority="1000" mode="M28">
...
<!--PATTERN oval-def_timedifferencefunctionrules-->
	...
	<!--RULE -->
<xsl:template match="oval-def:time_difference/oval-def:literal_component" priority="1001" mode="M29">
...
<xsl:apply-templates select="@*|*" mode="M29"/>
	...
	<!--RULE -->
<xsl:template match="oval-def:time_difference/oval-def:variable_component" priority="1000" mode="M29">
...
<!--PATTERN oval-def_regexcapturefunctionrules-->
	...
	<!--RULE -->
<xsl:template match="oval-def:regex_capture/oval-def:literal_component" priority="1001" mode="M30">
...
<xsl:apply-templates select="@*|*" mode="M30"/>
	...
	<!--RULE -->
<xsl:template match="oval-def:regex_capture/oval-def:variable_component" priority="1000" mode="M30">
...
<!--PATTERN oval-def_definition_entity_rules-->
	...
	<!--RULE -->
<xsl:template match="oval-def:objects/*/*[@var_ref]|oval-def:objects/*/*/*[@var_ref]|oval-def:states/*/*[@var_ref]|oval-def:states/*/*/*[@var_ref]" priority="1017" mode="M31">
...
<xsl:apply-templates select="@*|*" mode="M31"/>
	...
	<!--RULE -->
<xsl:template match="oval-def:objects/*/*[@var_ref]|oval-def:objects/*/*/*[@var_ref]" priority="1016" mode="M31">
...
<xsl:apply-templates select="@*|*" mode="M31"/>
	...
	<!--RULE -->
<xsl:template match="oval-def:objects/*/*[@var_check]|oval-def:objects/*/*/*[@var_check]" priority="1015" mode="M31">
...
<xsl:apply-templates select="@*|*" mode="M31"/>
	...
	<!--RULE -->
<xsl:template match="oval-def:states/*/*[@var_ref]|oval-def:states/*/*/*[@var_ref]" priority="1014" mode="M31">
...
<xsl:apply-templates select="@*|*" mode="M31"/>
	...
	<!--RULE -->
<xsl:template match="oval-def:states/*/*[@var_check]|oval-def:states/*/*/*[@var_check]" priority="1013" mode="M31">
...
<xsl:apply-templates select="@*|*" mode="M31"/>
	...
	<!--RULE -->
<xsl:template match="oval-def:objects/*/*[not(@datatype)]|oval-def:objects/*/*/*[not(@datatype)]|oval-def:states/*/*[not(@datatype)]|oval-def:states/*/*/*[not(@datatype)]" priority="1012" mode="M31">
...
<xsl:apply-templates select="@*|*" mode="M31"/>
	...
	<!--RULE -->
<xsl:template match="oval-def:objects/*/*[@datatype='binary']|oval-def:objects/*/*/*[@datatype='binary']|oval-def:states/*/*[@datatype='binary']|oval-def:states/*/*/*[@datatype='binary']" priority="1011" mode="M31">
...
<xsl:apply-templates select="@*|*" mode="M31"/>
	...
	<!--RULE -->
<xsl:template match="oval-def:objects/*/*[@datatype='boolean']|oval-def:objects/*/*/*[@datatype='boolean']|oval-def:states/*/*[@datatype='boolean']|oval-def:states/*/*/*[@datatype='boolean']" priority="1010" mode="M31">
...
<xsl:apply-templates select="@*|*" mode="M31"/>
	...
	<!--RULE -->
<xsl:template match="oval-def:objects/*/*[@datatype='evr_string']|oval-def:objects/*/*/*[@datatype='evr_string']|oval-def:states/*/*[@datatype='evr_string']|oval-def:states/*/*/*[@datatype='evr_string']" priority="1009" mode="M31">
...
<xsl:apply-templates select="@*|*" mode="M31"/>
	...
	<!--RULE -->
<xsl:template match="oval-def:objects/*/*[@datatype='fileset_revision']|oval-def:objects/*/*/*[@datatype='fileset_revision']|oval-def:states/*/*[@datatype='fileset_revision']|oval-def:states/*/*/*[@datatype='fileset_revision']" priority="1008" mode="M31">
...
<xsl:apply-templates select="@*|*" mode="M31"/>
	...
	<!--RULE -->
<xsl:template match="oval-def:objects/*/*[@datatype='float']|oval-def:objects/*/*/*[@datatype='float']|oval-def:states/*/*[@datatype='float']|oval-def:states/*/*/*[@datatype='float']" priority="1007" mode="M31">
...
<xsl:apply-templates select="@*|*" mode="M31"/>
	...
	<!--RULE -->
<xsl:template match="oval-def:objects/*/*[@datatype='ios_version']|oval-def:objects/*/*/*[@datatype='ios_version']|oval-def:states/*/*[@datatype='ios_version']|oval-def:states/*/*/*[@datatype='ios_version']" priority="1006" mode="M31">
...
<xsl:apply-templates select="@*|*" mode="M31"/>
	...
	<!--RULE -->
<xsl:template match="oval-def:objects/*/*[@datatype='int']|oval-def:objects/*/*/*[@datatype='int']|oval-def:states/*/*[@datatype='int']|oval-def:states/*/*/*[@datatype='int']" priority="1005" mode="M31">
...
<xsl:apply-templates select="@*|*" mode="M31"/>
	...
	<!--RULE -->
<xsl:template match="oval-def:objects/*/*[@datatype='ipv4_address']|oval-def:objects/*/*/*[@datatype='ipv4_address']|oval-def:states/*/*[@datatype='ipv4_address']|oval-def:states/*/*/*[@datatype='ipv4_address']" priority="1004" mode="M31">
...
<xsl:apply-templates select="@*|*" mode="M31"/>
	...
	<!--RULE -->
<xsl:template match="oval-def:objects/*/*[@datatype='ipv6_address']|oval-def:objects/*/*/*[@datatype='ipv6_address']|oval-def:states/*/*[@datatype='ipv6_address']|oval-def:states/*/*/*[@datatype='ipv6_address']" priority="1003" mode="M31">
...
<xsl:apply-templates select="@*|*" mode="M31"/>
	...
	<!--RULE -->
<xsl:template match="oval-def:objects/*/*[@datatype='string']|oval-def:objects/*/*/*[@datatype='string']|oval-def:states/*/*[@datatype='string']|oval-def:states/*/*/*[@datatype='string']" priority="1002" mode="M31">
...
<xsl:apply-templates select="@*|*" mode="M31"/>
	...
	<!--RULE -->
<xsl:template match="oval-def:objects/*/*[@datatype='version']|oval-def:objects/*/*/*[@datatype='version']|oval-def:states/*/*[@datatype='version']|oval-def:states/*/*/*[@datatype='version']" priority="1001" mode="M31">
...
<!--PATTERN oval-def_no_var_ref_with_records-->
	...
	<!--RULE -->
<xsl:template match="oval-def:objects/*/*[@datatype='record']|oval-def:states/*/*[@datatype='record']" priority="1000" mode="M32">
<svrl:fired-rule xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oval-def:objects/*/*[@datatype='record']|oval-def:states/*/*[@datatype='record']"/>
...
<!--PATTERN oval-def_definition_entity_type_check_rules-->
	...
	<!--RULE -->
<xsl:template match="oval-def:objects/*/*[not((@xsi:nil='1' or @xsi:nil='true')) and not(@var_ref) and @datatype='int']|oval-def:objects/*/*/*[not(@var_ref) and @datatype='int']|oval-def:states/*/*[not((@xsi:nil='1' or @xsi:nil='true')) and not(@var_ref) and @datatype='int']|oval-def:states/*/*/*[not(@var_ref) and @datatype='int']" priority="1000" mode="M33">
...
<!--PATTERN oval-sc_entity_rules-->
	...
	<!--RULE -->
<xsl:template match="oval-sc:system_data/*/*|oval-sc:system_data/*/*/*" priority="1001" mode="M34">
...
<xsl:apply-templates select="@*|*" mode="M34"/>
	...
	<!--RULE -->
<xsl:template match="oval-sc:system_data/*/*[not((@xsi:nil='1' or @xsi:nil='true')) and @datatype='int']|oval-sc:system_data/*/*/*[not((@xsi:nil='1' or @xsi:nil='true')) and @datatype='int']" priority="1000" mode="M34">
